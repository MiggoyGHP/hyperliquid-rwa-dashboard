...
export function renderRiskReward({ calc, worst30d, coin }, els) {
  ...
  const rewards = [
    `<li><b>${fmtUsd(calc.grossFunding)}</b> of funding over the period at your assumed rate — collected hour by hour, whether the stock goes up or down.</li>`,
    `<li>The hedge means you are <b>not betting on the stock's direction</b>. You earn the fee, not the price move.</li>`,
  ];
  ...
  const worstCase = {
    stock: `<b>Worst case:</b> negative funding while you unwind, plus a fast gap that liquidates the perp before the stock hedge offsets it. Hedged ≠ risk-free: the legs can be forced apart. You can lose several times the funding you hoped to earn, though the stock hedge caps directional loss.`,
